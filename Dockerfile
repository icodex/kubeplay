...
RUN ARCH=$(uname -m | sed 's/x86_64/amd64/;s/aarch64/arm64/') \
    ...
    && wget -q -k https://github.com/icodex/skopeo/releases/download/${SKOPEO_VERSION}/skopeo-linux-${ARCH} -O /tools/skopeo-linux-${ARCH} \
    && wget -q -k https://github.com/icodex/mkcert/releases/download/${MKCERT_VERSION}/mkcert-${MKCERT_VERSION}-linux-${ARCH} -O /tools/mkcert-linux-${ARCH} \
